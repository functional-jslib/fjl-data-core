...
import {map} from 'fjl';
import {unwrapMonad, expectInstanceOf, expectFunction, expectEqual, add, multiply} from '../utils';
...
describe('monad.Maybe', function () {
    ...
    describe('#maybe', function () {
        ...
        it ('should return the `left` when passed in functor maps to a functor of ' +
            '`null`, `undefined` or `Nothing` otherwise contained value within passed in functor', function () {
