...
(() => {
    ...
    function pointerNeighbours(pointer) {
        let offsets = [new Pos(-1, -1), new Pos(-1, 0), new Pos(-1, 1), new Pos(0, -1), new Pos(0, 1), new Pos(1, -1), new Pos(1, 0), new Pos(1, 1)],
    ...
    function liveNeighbours(pointer) {
        return filter(pointerNeighbours(pointer), id).length;
    }
