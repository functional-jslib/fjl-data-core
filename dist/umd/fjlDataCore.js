(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "./functor/Functor", "./functor/Apply", "./functor/Applicative", "./functor/Bifunctor", "./monad/Monad", "./io/IO", "./maybe/Maybe", "./either/Either", "./utils"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("./functor/Functor"), require("./functor/Apply"), require("./functor/Applicative"), require("./functor/Bifunctor"), require("./monad/Monad"), require("./io/IO"), require("./maybe/Maybe"), require("./either/Either"), require("./utils"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.Functor, global.Apply, global.Applicative, global.Bifunctor, global.Monad, global.IO, global.Maybe, global.Either, global.utils);
    global.fjlDataCore = mod.exports;
  }
})(this, function (_exports, _Functor, _Apply, _Applicative, _Bifunctor, _Monad, _IO, _Maybe, _Either, _utils) {
  "use strict";
